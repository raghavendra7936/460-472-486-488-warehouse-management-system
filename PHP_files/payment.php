...
<body>
    ...
    <?php }
      ...
      <?php
            ...
            $conn1 = mysqli_connect("localhost","rupak","","WholeSale_Management");

            $date = date("Y-m-d", strtotime($_SESSION['TID']));

            // Insert into the database with the formatted date
            $sql1 = "INSERT INTO payment (Mode, Amount_Paid, TransactionID, Transaction_Date)
            VALUES('$mode','$amtpaid','".$_SESSION['TransID']."','2024')";
